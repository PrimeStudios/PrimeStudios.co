...
<html lang="en" dir="ltr">
	...
	<head>
		<meta charset="utf-8">
		<title>
			<?php echo $pageName; ?> - Prime Studios</title>
	...
	<body>
		...
		<p id="open_header" class="header-bars" onclick="document.getElementById('right').style.display = 'initial'; document.getElementById('open_header').style.display = 'none'; document.getElementById('close_header').style.display = 'block';"><span class="bars-border"><i
						 class="fas fa-bars"></i></span></p>
		<p id="close_header" class="header-bars hidden" onclick="document.getElementById('right').style.display = 'none'; document.getElementById('open_header').style.display = 'block'; document.getElementById('close_header').style.display = 'none';"><span class="bars-border-two"><i
